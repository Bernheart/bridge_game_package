...
ArbiterResult _$ArbiterResultFromJson(Map<String, dynamic> json) =>
    ArbiterResult(
      (json['resultType'] as Map<String, dynamic>).map(
        (k, e) => MapEntry(
          $enumDecode(_$PairDirectionEnumMap, k),
...
Map<String, dynamic> _$ArbiterResultToJson(
  ArbiterResult instance,
) => <String, dynamic>{
  'resultType': instance.resultType.map(
    (k, e) =>
...
const _$PairDirectionEnumMap = {PairDirection.NS: 'NS', PairDirection.EW: 'EW'};
